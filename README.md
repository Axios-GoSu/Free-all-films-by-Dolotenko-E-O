...
3. Установите скрипт, перейдя по [этой ссылке](https://github.com/Axios-GoSu/Free-all-films-by-Dolotenko-E-O/raw/main/userscript/tape-operator.user.js). _(либо скачайте `tape-operator.user.js` из папки `userscript` и установите вручную)_
...
MIT _([LICENSE](https://github.com/Axios-GoSu/Free-all-films-by-Dolotenko-E-O/blob/main/LICENSE) файл)_
